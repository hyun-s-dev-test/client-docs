...
title: CI/CD
date: "2022-03-03"
description: github action 을 이용해 CI/CD를 구현하기까지의 이슈들.
---

    1. GitHub Action 사용을 위한 yml 에서의 이슈
    2. aws ec2에 자동 배포하기 위한 aws 설정 이슈
    3. ec2에 빌드폴더 올리고 nginx로 자동 배포 하기까지의 이슈
